...
public abstract class AbstractRule extends AbstractPropertySource implements
		Rule {
	...
	// if (this.language != null && this instanceof ImmutableLanguage &&
	...
	// */
	// public void setMinimumLanguageVersion(LanguageVersion
	...
	// */
	// public void setMaximumLanguageVersion(LanguageVersion
	...
	//
	// /**
	// * This implementation returns a new instance of {@link ParserOptions}
	...
	public void addRuleChainVisit(Class<? extends Node> nodeClass) {
		if (!nodeClass.getSimpleName().startsWith("AST")) {
			throw new IllegalArgumentException(
					"Node class does not start with 'AST' prefix: " + nodeClass);
		}
	...
	public void addViolation(Object data, Node node, String arg) {
		RuleContext ruleContext = (RuleContext) data;
		ruleContext.addRuleViolation(ruleContext, this, node,
				this.getMessage(), new Object[] { arg });
	}
	...
	public void addViolationWithMessage(Object data, Node node, String message) {
		RuleContext ruleContext = (RuleContext) data;
		ruleContext.addRuleViolation(ruleContext, this, node, message, null);
	}
	...
	public void addViolationWithMessage(Object data, Node node, String message,
		...
		RuleContext ruleContext = (RuleContext) data;
		ruleContext.addRuleViolation(ruleContext, this, node, message,
				beginLine, endLine, null);
	}
	...
	public void addViolationWithMessage(Object data, Node node, String message,
			Object[] args) {
		RuleContext ruleContext = (RuleContext) data;
		ruleContext.addRuleViolation(ruleContext, this, node, message, args);
	}
	...
	public boolean equals(Object o) {
		...
		if (equality) {
			Rule that = (Rule) o;
			equality = getName().equals(that.getName())
			// && getPriority().equals(that.getPriority())
					&& getPropertiesByPropertyDescriptor().equals(
	...
	public int hashCode() {
		...
		return getClass().getName().hashCode()
				...
				// + getPriority().hashCode()
				+ (propertyValues != null ? propertyValues.hashCode() : 0);
	}
}
